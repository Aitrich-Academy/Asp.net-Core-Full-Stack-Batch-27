...
var Authentication = /** @class */ (function () {
    ...
    Authentication.prototype.showMenuItems = function () {
        return __awaiter(this, void 0, void 0, function () {
            var jobObject, dashboardObject, jobseekerObject, option, _a, companyName, searchCompany, opt;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        console.log("6. Search jobs by company or title ");
                        console.log("");
                    ...
                    case 6:
                        ...
                        this.showContinuePrompt = true;
                        return [3 /*break*/, 10];
                    case 7: return [4 /*yield*/, this.askQuestion("Enter the company name or title: ")];
                    case 8:
                        searchCompany = _b.sent();
                        jobseekerObject.searchByCompany(searchCompany);
                        this.showContinuePrompt = true;
                        return [3 /*break*/, 10];
